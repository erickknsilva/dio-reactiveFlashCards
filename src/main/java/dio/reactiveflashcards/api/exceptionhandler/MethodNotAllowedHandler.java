...
public class MethodNotAllowedHandler extends AbstractHandlerException<MethodNotAllowedException> {
    ...
    public MethodNotAllowedHandler(final ObjectMapper objMapper) {
        super(objMapper);
    }

    @Override
    Mono<Void> handleException(ServerWebExchange exchange, MethodNotAllowedException ex) {
        return Mono.fromCallable(() -> {
                ...
                .doFirst(() ->
                        log.error(" === NotFoundException: Method [{}] is not allowed at [{}]",
