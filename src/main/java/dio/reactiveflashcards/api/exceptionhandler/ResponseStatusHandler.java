...
import static dio.reactiveflashcards.domain.exception.BaseErrorMessage.GENERIC_NOT_FOUND;
...
public class ResponseStatusHandler extends AbstractHandlerException<ResponseStatusException> {
    ...
    public ResponseStatusHandler(ObjectMapper objMapper) {
        super(objMapper);
    }

    @Override
    Mono<Void> handleException(ServerWebExchange exchange, ResponseStatusException ex) {
